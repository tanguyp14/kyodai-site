...
1. `git init`
2. `git clone https://github.com/pixelea-fr/Kyodai.git`
3. `rm -rf .git`
4. `cd Kyodai`
5. `rm -rf .git`
6. `npm install`
...
- Effectuer un rechercher/remplacer sur 'kyodai' et le remplacer avec un slug correspondant au projet
- Effectuer un rechercher/remplacer sur 'Kyodai' et le remplacer avec un nom correspondant au projet
